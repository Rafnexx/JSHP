...
function checkIfValid(val1, val2) {
    if(val1 > val2) {
...
function moreComplexCheck(val1, val2, val3) {
    if(val1 > val2) {
        if(val1 > (val2 + val3)) {
            return "val1 is greater than val1 + val2"
        }
        return "val1 is greater than val2 but not greater than val2 + val3"
    }
    return "val1 is not greater than val 2"
}
